...
```bash
pnpm add @fabiogaliano/ladle-react
```
...
```bash
npm install @fabiogaliano/ladle-react
```
...
```bash
yarn add @fabiogaliano/ladle-react
```
...
cd my-ladle
pnpm init
pnpm add @fabiogaliano/ladle-react react react-dom
mkdir src
...
cd my-ladle
yarn init --yes
yarn add @fabiogaliano/ladle-react react react-dom
mkdir src
echo "export const World = () => <p>Hey</p>;" > src/hello.stories.tsx
yarn ladle serve
```
...
cd my-ladle
npm init --yes
npm install @fabiogaliano/ladle-react react react-dom
mkdir src
echo "export const World = () => <p>Hey</p>;" > src/hello.stories.tsx
npx ladle serve
```
